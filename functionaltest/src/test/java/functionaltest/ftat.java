...
public class ftat {
	...
	public String URL = "http://18.136.119.124:8080/QAWebapp/";
	public String URL1 = "http://18.136.119.124:8080/QAWebapp/avncreatepage.jsp";
	...
	public void pageredirection() {
		driver.findElement(By.partialLinkText("Home2")).click();
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
